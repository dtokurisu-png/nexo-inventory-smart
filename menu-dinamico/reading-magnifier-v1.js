...
const blocked='input,textarea,select,[contenteditable="true"],.miseCheck,.mopCheck,.icon,.lang,.installBtn,.taxonomyImageClose,.taxonomyProductPhotoBtn,.heroPhotoBtn,[data-photo-target],#nexoPhotoLayer,.nexoBatchButton,#nexoBatchLayer,.photoAction,.photoBtn';
